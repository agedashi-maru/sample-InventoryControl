...
public class UpdateConf extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action == null) {
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/menujsp/updateMenu.jsp");
			...
			if (flag) {
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/confjsp/confUpdate.jsp");
				dispatcher.forward(request, response);
			} else {
