...
<table>
<tr><td class="id">商品ID</td><td class="inp"><input type="text" name="deleteid1" size="5"></td></tr>
<tr><td class="id">商品ID</td><td class="inp"><input type="text" name="deleteid2" size="5"></td></tr>
<tr><td class="id">商品ID</td><td class="inp"><input type="text" name="deleteid3" size="5"></td></tr>
<tr><td class="id">商品ID</td><td class="inp"><input type="text" name="deleteid4" size="5"></td></tr>
<tr><td class="id">商品ID</td><td class="inp"><input type="text" name="deleteid5" size="5"></td></tr>
</table>
...
<td class="type2"><input type="text" name="deleteitem" size="15"></td>
<td class="type3"><input type="text" name="deletekind" size="10"></td>
<td class="type4"><input type="text" name="deletegroup" size="5"></td>
<td class="type5"><input type="text" name="deletestock" size="3"></td>
</tr>
</table>
<br>
<table class="scroll">
