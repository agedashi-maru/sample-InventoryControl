...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/insert.css" type="text/css">
<title>新規商品登録</title>
</head>
<body>
<br>
...
<td><input type="text" name="insertstock1" size="5" class="stock"></td>
</tr>
<tr>
...
<td><input type="text" name="insertstock2" size="5" class="stock"></td>
</tr>
<tr>
...
<td><input type="text" name="insertstock3" size="5" class="stock"></td>
</tr>
<tr>
...
<td><input type="text" name="insertstock4" size="5" class="stock"></td>
</tr>
<tr>
...
<td><input type="text" name="insertstock5" size="5" class="stock"></td>
</tr>
</table>
<br>
