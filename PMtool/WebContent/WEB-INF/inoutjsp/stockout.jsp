...
<td class="count">出庫数</td><td class="inp"><input type="text" name="count1" size="5"></td>
</tr>
<tr>
<td class="id">商品ID</td><td class="inp"><input type="text" name="stockid2" size="8"></td>
<td class="count">出庫数</td><td class="inp"><input type="text" name="count2" size="5"></td>
</tr>
<tr>
<td class="id">商品ID</td><td class="inp"><input type="text" name="stockid3" size="8"></td>
<td class="count">出庫数</td><td class="inp"><input type="text" name="count3" size="5"></td>
</tr>
<tr>
<td class="id">商品ID</td><td class="inp"><input type="text" name="stockid4" size="8"></td>
<td class="count">出庫数</td><td class="inp"><input type="text" name="count4" size="5"></td>
</tr>
<tr>
<td class="id">商品ID</td><td class="inp"><input type="text" name="stockid5" size="8"></td>
<td class="count">出庫数</td><td class="inp"><input type="text" name="count5" size="5"></td>
</tr>
</table>
